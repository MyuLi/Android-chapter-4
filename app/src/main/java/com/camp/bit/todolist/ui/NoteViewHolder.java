...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    private RelativeLayout view_layer;
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator) {
        ...
        view_layer = itemView.findViewById(R.id.view_layer);
    }
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority()){
            ...
            case 2:{
                view_layer.setBackgroundColor(Color.parseColor("#FF9D73"));
                break;
            }
            case 3:{
                view_layer.setBackgroundColor(Color.parseColor("#FF5D40"));
                break;
            }
            default:{
